...
--
-- Host: 127.0.0.1
-- Tempo de geração: 06-Set-2023 às 13:35
...
ALTER TABLE `dependentes`
  ADD PRIMARY KEY (`codigo`),
  ADD KEY `fk_departamento` (`cod_funcionario`);
...
--
ALTER TABLE `dependentes`
  ADD CONSTRAINT `fk_departamento` FOREIGN KEY (`cod_funcionario`) REFERENCES `funcionario` (`codigo`);
